 ...
 * Receives hook event JSON on stdin and forwards it to every live Podium
 * server. Designed to fail silently so it never blocks Claude
 * Code, and to fan out across multiple Podium instances (e.g. the macOS desktop
